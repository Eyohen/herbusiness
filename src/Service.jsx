    ...
    <div>
      <div style={{ display: "flex", flexDirection: "row" }}>
        <div>
          ...
          <h4 style={{ fontSize: 40, fontWeight: "400", marginLeft: 100 }}>
            Lorem ipsum dolor sit amet,
            <br />
            consectetur adipiscing elit. Non <br />
            lacus cursus ut nec non id <br />
            aliquam nibh libero. Tortor quam <br /> pharetra neque.
          </h4>
        </div>
        ...
        <img
          ...
          style={{ width: 778, height: 585, marginTop: 56, marginLeft: 151 }}
        ></img>
      </div>
      <div
        style={{
